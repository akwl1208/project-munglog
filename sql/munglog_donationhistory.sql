...
CREATE TABLE `donationhistory` (
  `dh_num` int NOT NULL AUTO_INCREMENT,
  `dh_dp_num` int NOT NULL,
  `dh_mb_num` int NOT NULL,
  `dh_dona_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `dh_amount` int NOT NULL,
  PRIMARY KEY (`dh_num`),
  KEY `dh_dp_num_idx` (`dh_dp_num`),
  KEY `dh_mb_num_idx` (`dh_mb_num`),
  CONSTRAINT `dh_dp_num` FOREIGN KEY (`dh_dp_num`) REFERENCES `donationpost` (`dp_num`),
  CONSTRAINT `dh_mb_num` FOREIGN KEY (`dh_mb_num`) REFERENCES `member` (`mb_num`)

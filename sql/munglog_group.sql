...
CREATE TABLE `group` (
  ...
  `gr_represent` varchar(20) NOT NULL,
  `gr_type` varchar(20) NOT NULL,
  `gr_reg_num` varchar(13) NOT NULL,
  `gr_contact_num` varchar(13) NOT NULL,
  `gr_address` varchar(255) DEFAULT '',
  `gr_webpage` varchar(255) DEFAULT '',
  PRIMARY KEY (`gr_num`)

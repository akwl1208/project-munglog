...
CREATE TABLE `verification` (
  `vr_email` varchar(50) NOT NULL,
  `vr_veri_number` char(8) NOT NULL,
  `vr_failure_count` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`vr_email`)
...
-- Dump completed on 2022-09-14 20:43:45

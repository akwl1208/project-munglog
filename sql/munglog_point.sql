...
CREATE TABLE `point` (
  ...
  `pi_mb_num` int NOT NULL,
  `pi_process` char(2) NOT NULL,
  `pi_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `pi_history` varchar(100) NOT NULL,
  `pi_amount` int NOT NULL,
  PRIMARY KEY (`pi_num`),
  KEY `pi_mb_num_idx` (`pi_mb_num`),
  CONSTRAINT `pi_mb_num` FOREIGN KEY (`pi_mb_num`) REFERENCES `member` (`mb_num`) ON DELETE CASCADE ON UPDATE CASCADE

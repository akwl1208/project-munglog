...
{color: #fb9600;}
	...
	.main .box-content .challenge{
		float: right; font-weight: bold; margin-right: 37px;
	}
	.main .box-content .challenge:hover{color: #fb9600;}
</style>
</head>
<!-- html ********************************************************************************************************* -->
<body>
	<!-- 제목 -------------------------------------------------------- -->
	<div class="box-title">
		<i class="fa-solid fa-paw"></i><span>챌린지 상세보기</span>
		<div class="box-message">챌린지에 참여한 사진을 보고 좋아요를 눌러주세요. 슬라이드쇼도 볼 수 있습니다.</div>
	</div>
	<!-- box-content ------------------------------------------------------------------------------------------------- -->

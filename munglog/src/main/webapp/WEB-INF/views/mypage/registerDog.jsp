...
<script>
	...
	/* 이벤트 **************************************************************************** */
		...
		$(document).on('click','.box-content .box-more .btn-more', function(){
			...
			html += 		'<input type="text" class="form-control dg_name" name="dlist['+index+'].dg_name" id="dg_name'+index+'">';
			html +=			'<label class="nameError error"></label>';
			html +=		'</div>';
			html +=		'<div class="form-group">';
			html +=			'<label>강아지 등록번호 (선택)</label>';
			html +=			'<input type="text" class="form-control dg_reg_num" name="dlist['+index+'].dg_reg_num" id="dg_reg_num'+index+'">';
			html +=			'<label class="regNumError error"></label>';
			html +=		'</div>';
			html +=		'<div class="form-group">';
			html +=			'<label>강아지 생일 (선택)</label>';
			html +=			'<input type="text" class="form-control dg_birth" name="dlist['+index+'].dg_birth" id="dg_birth'+index+'">';
			html +=			'<label class="birthError error"></label>';
			html +=		'</div>';
			html +=	'</div>';
			html +=	'<hr>';
